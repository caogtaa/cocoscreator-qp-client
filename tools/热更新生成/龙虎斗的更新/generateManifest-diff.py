...
versionManifestPath = "version/lhd_version.manifest"    #由此脚本生成的version.manifest文件路径
projectManifestPath = "version/lhd_project.manifest"    #由此脚本生成的project.manifest文件路径
thisTimeUpdate = "version/lhd_thisTime.manifest" #对比两次版本需要更新的内容
tempprojectManifestPath = "project.manifest" #由此脚本生成的project.manifest临时文件路径

gameResPath = "lhd"
gameHotUpdatePath = "remote/lhd"
